...
public VirtualPetShelter() {
    ...
    shelter.add(new RoboticDog("Samuel",5,5));
    shelter.add(new RoboticCat("James",7,7));
    shelter.add(new OrganicDog("Spoon",8,8,8,8));
    shelter.add(new OrganicCat("Fork",6,6,6,6));


}


public void adoptPet(String name) {shelter.remove(findPetByName(name));}
...
public VirtualPet getPet(int index) {return shelter.get(index);}
